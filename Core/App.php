...
class App implements DatabaseConfigInterface
{
    ...
    private const DB_NAME = 'jeux_video';
    ...
    private function registerRoutes(): void
    {
        ...
        $this->router->get('/', [JeuController::class, 'index']);

        $this->router->get('/detail/{id}', [JeuController::class, 'detail']);

        $this->router->get('/pegi/{id}', [JeuController::class, 'listPegi']);
    }
